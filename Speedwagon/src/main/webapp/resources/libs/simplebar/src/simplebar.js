...
export default class SimpleBar {
   ...
   */
    static getRtlHelpers() {
        ...
        return { // determines if the scrolling is responding with negative values
    ...
    init() { // Save a reference to the instance, so we know this DOM node has already been instancied
    ...
    initDOM() { // make sure this element doesn't have the elements yet
        if (Array
                .prototype
                .filter
                .call(this.el.children, child => child.classList.contains(this.classNames.wrapper))
                    .length) { // assume that element has his DOM already initiated
            ...
            this.contentEl = this.options.contentNode || this.el.querySelector(`.${
            ...
            this.placeholderEl = this.findChild(this.wrapperEl, `.${
            ...
            this
                .wrapperEl
                .classList
                .add(this.classNames.wrapper);
            this
                .contentWrapperEl
                .classList
                .add(this.classNames.contentWrapper);
            this
                .offsetEl
                .classList
                .add(this.classNames.offset);
            this
                .maskEl
                .classList
                .add(this.classNames.mask);
            this
                .contentEl
                .classList
                .add(this.classNames.contentEl);
            this
                .placeholderEl
                .classList
                .add(this.classNames.placeholder);
            this
                .heightAutoObserverWrapperEl
                .classList
                .add(this.classNames.heightAutoObserverWrapperEl);
            this
                .heightAutoObserverEl
                .classList
                .add(this.classNames.heightAutoObserverEl);
        ...
        if (!this
            ...
            this
                ...
                .el
                .classList
                .add(this.classNames.horizontal);
            this
                .axis
                .y
                .track
    ...
    recalculate() {
        ...
        this
            .placeholderEl
            .style
            .height = `${contentElScrollHeight}px`;
        const contentWrapperElOffsetHeight = this.contentWrapperEl.offsetHeight;
        this
            .axis
            .x
            .isOverflowing = contentElScrollWidth > contentElOffsetWidth;
        this
            .axis
            .y
            .isOverflowing = contentElScrollHeight > contentWrapperElOffsetHeight;
        // Set isOverflowing to false if user explicitely set hidden overflow
        this
            .axis
            .x
            .isOverflowing = elOverflowX === 'hidden'
                ? false
                : this
                    .axis
                    .x
        ...
        this
            .axis
            .y
            .isOverflowing = elOverflowY === 'hidden'
                ? false
                : this
                    .axis
                    .y
        ...
        this
            .axis
            .x
            .forceVisible = this.options.forceVisible === 'x' || this.options.forceVisible === true;
        this
            .axis
            .y
            .forceVisible = this.options.forceVisible === 'y' || this.options.forceVisible === true;
        this.hideNativeScrollbar();
        // Set isOverflowing to false if scrollbar is not necessary (content is shorter than offset)
        let offsetForXScrollbar = this
            .axis
            .x
            .isOverflowing
                ? this.scrollbarWidth
                : 0;
        let offsetForYScrollbar = this
            .axis
            .y
            .isOverflowing
                ? this.scrollbarWidth
        ...
        this
            ...
            .axis
            .x
            .isOverflowing && contentElScrollWidth > contentWrapperElOffsetWidth - offsetForYScrollbar;
        this
            .axis
            .y
            .isOverflowing = this
            .axis
            .y
            .isOverflowing && contentElScrollHeight > contentWrapperElOffsetHeight - offsetForXScrollbar;
        this
            .axis
            .x
            .scrollbar
            .size = this.getScrollbarSize('x');
        this
            .axis
            .y
            .scrollbar
            .size = this.getScrollbarSize('y');
        this
            .axis
            .x
            .scrollbar
   ...
   */
    getScrollbarSize(axis = 'y') {
        ...
        const trackSize = this
            .axis[axis]
            .track
            .el[this.axis[axis].offsetSizeAttr];
        let scrollbarSize;
    ...
    positionScrollbar(axis = 'y') {
        ...
        scrollOffset = axis === 'x' && this.isRtl && SimpleBar.getRtlHelpers().isRtlScrollingInverted
            ? - scrollOffset
            : scrollOffset;
   ...
   */
    ...
    onMouseMoveForAxis(axis = 'y') {
        ...
        this
            ...
            .el
            .getBoundingClientRect();
        const isWithinScrollbarBoundsX = this.isWithinBounds(this
            .axis[axis]
            .scrollbar
            .rect);
        if (isWithinScrollbarBoundsX) {
            ...
            this
                ...
                .el
                .classList
                .remove(this.classNames.hover);
        }
        if (this.isWithinBounds(this
            .axis[axis]
            .track
            .rect)) {
    ...
    onWindowResize = () => { // Recalculate scrollbarWidth in case it's a zoom
        this.scrollbarWidth = this.getScrollbarWidth();
        this.hideNativeScrollbar();
    };
    /**
   ...
   */
    hideScrollbars = () => {
        ...
        if (!this.isWithinBounds(this
            ...
            this
                ...
                .el
                .classList
                .remove(this.classNames.visible);
            this
                .axis
                .y
                .isVisible = false;
    ...
    onPointerEvent = e => {
        ...
        if (this
                ...
                .x
                .forceVisible) {
            isWithinTrackXBounds = this.isWithinBounds(this
                .axis
                .x
                .track
                .rect);
        ...
        if (this
                ...
                .y
                .forceVisible) {
            isWithinTrackYBounds = this.isWithinBounds(this
                .axis
                .y
                .track
                .rect);
   ...
   */
    drag = e => {
        ...
        let dragPos = eventOffset - track.rect[this.axis[this.draggedAxis].offsetAttr] - this.axis[this.draggedAxis].dragOffset;
        ...
        if (this.draggedAxis === 'x') {
            scrollPos = this.isRtl && SimpleBar.getRtlHelpers().isRtlScrollbarInverted
                ? scrollPos - (trackSize + scrollbar.size)
                : scrollPos;
            scrollPos = this.isRtl && SimpleBar.getRtlHelpers().isRtlScrollingInverted
                ? - scrollPos
                : scrollPos;
        }
   ...
   */
    onEndDrag = e => {
        ...
        this
            .el
            .classList
            .remove(this.classNames.dragging);
        ...
        const scrollTo = () => {
            if (dir === -1) {
                if (scrolled > scrollSize) {
                    ...
                    this.contentWrapperEl.scrollTo({[this.axis[axis].offsetAttr]: scrolled});
   ...
   */
    ...
    getScrollbarWidth() { // Try/catch for FF 56 throwing on undefined computedStyles
   ...
   */
    findChild(el, query) {
        ...
        return Array
            .prototype
            .filter
            .call(el.children, child => matches.call(child, query))[0];
    }
}